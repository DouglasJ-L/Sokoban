...
public class Controller extends View implements Serializable{
    ...
    public Controller(Model[] dataModel) throws IOException {
        ...
        soundManager.addSound("move", "C:\\Users\\dougl\\Desktop\\Objekt progg\\Projekt\\soundeffects\\step1.wav");
        soundManager.addSound("reset", "C:\\Users\\dougl\\Desktop\\Objekt progg\\Projekt\\soundeffects\\reset.wav");
        soundManager.addSound("win", "C:\\Users\\dougl\\Desktop\\Objekt progg\\Projekt\\soundeffects\\win.wav");
        soundManager.addSound("moveBox","C:\\Users\\dougl\\Desktop\\Objekt progg\\Projekt\\soundeffects\\move_box.wav");
        soundManager.addSound("newLvl","C:\\Users\\dougl\\Desktop\\Objekt progg\\Projekt\\soundeffects\\next_level.wav");
        soundManager.addSound("stuck","C:\\Users\\dougl\\Desktop\\Objekt progg\\Projekt\\soundeffects\\stuck.wav");
